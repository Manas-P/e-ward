<?php
    ...
    if(isset($_POST['changePass'])){
        $updatePassQuery="UPDATE `tbl_house_member` SET `password`='$newPass' WHERE `userid`='$userid'";
        $updatePassRes=mysqli_query($conn,$updatePassQuery);
        if($updatePassRes){
            echo "<script>window.location='../../view/pages/house_member/change_password.php'</script>";
