<div class="sidebar" style="position: fixed;">
                ...
                <div class="links">
                    <div class="menus">
                        ...
                        <a href="../../pages/ward_member/houses.php" class="menu">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path class="str" d="M8.25 20.1667H4.58333C4.0971 20.1667 3.63079 19.9736 3.28697 19.6297C2.94315 19.2859 2.75 18.8196 2.75 18.3334V8.25004L11 1.83337L19.25 8.25004V18.3334C19.25 18.8196 19.0568 19.2859 18.713 19.6297C18.3692 19.9736 17.9029 20.1667 17.4167 20.1667H13.75" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path class="str" d="M8.25 20.1667V11H13.75V20.1667" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        ...
                        <a href="../../pages/ward_member/notification.php" class="menu">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
