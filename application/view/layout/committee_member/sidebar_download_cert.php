<div class="sidebar" style="position: fixed;">
    ...
    <div class="links">
        <div class="menus">
            ...
            <a href="./download_cert.php" class="menu active">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="str active" d="M13.4636 1.83328V5.72912C13.4636 5.98743 13.5662 6.23516 13.7488 6.41781C13.9315 6.60046 14.1792 6.70307 14.4375 6.70307H18.3334" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path class="str active" d="M4.69794 6.70307V3.7812C4.69794 3.26458 4.90316 2.76912 5.26847 2.40381C5.63377 2.03851 6.12923 1.83328 6.64585 1.83328H13.4636L18.3334 6.70307V17.4166C18.3334 17.9332 18.1281 18.4287 17.7628 18.794C17.3975 19.1593 16.9021 19.3645 16.3854 19.3645H11.5156" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path class="str active" d="M5.67188 15.4687C7.28558 15.4687 8.59375 14.1605 8.59375 12.5468C8.59375 10.9331 7.28558 9.62495 5.67188 9.62495C4.05817 9.62495 2.75 10.9331 2.75 12.5468C2.75 14.1605 4.05817 15.4687 5.67188 15.4687Z" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <line class="str active" x1="9.56769" y1="9.12495" x2="15.4114" y2="9.12496" stroke="#1E1E1E"/>
                    <line class="str active" x1="10.5417" y1="12.0468" x2="15.4115" y2="12.0468" stroke="#1E1E1E"/>
                    <path class="str active" d="M4.21094 15.4687L2.75 20.3385L5.67187 18.8776L8.59375 20.3385L7.13281 15.4687" stroke="#1E1E1E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <div class="text active">Download certificate</div>
            </a>
            <a href="./change_password.php" class="menu">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
