...
<html lang="en">
    ...
    <body>
        <section class="main">
            <!-- ==========Sidebar============= -->
            <?php
                include '../../layout/committee_member/sidebar_change_password.php'
            ?>
            <!-- ==========Sidebar End============= -->
            <div class="container">
                <div class="header">
                ...
                <div class="change-pass">
                    ...
                    <form id="cp-form" action="../../../model/committee_member/change_password.php" method="post" enctype="multipart/form-data">
        ...
        <script>
            ...
            function validateCurrentPass ( curpass )
            {
                ...
                if ( curpass.length != 0 ){
                    $.ajax( {
                        url: "../../../model/committee_member/change_password.php",
                        type: "POST",
                        data: {
                            curPass: curpass,
                            userId: userId
