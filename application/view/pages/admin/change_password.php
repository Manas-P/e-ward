...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../../../public/assets/css/admin/change_password.css">
    ...
    <body>
        <section class="main">
            <!-- ==========Sidebar============= -->
            <?php
                include '../../layout/admin/sidebar_change_password.php'
            ?>
            <!-- ==========Sidebar End============= -->
            <div class="container">
                <div class="header">
                ...
                <div class="change-pass">
                    ...
                    <form id="cp-form" action="../../../model/admin/change_password.php" method="post" enctype="multipart/form-data">
                        <div class="inputs">
        ...
        <script>
            ...
            function validateCurrentPass ( curpass )
            {
                ...
                if ( curpass.length != 0 ){
                    $.ajax( {
                        url: "../../../model/admin/change_password.php",
                        type: "POST",
                        data: {
                            curPass: curpass,
                            userId: userId
