...
?>
    ...
    <head>
        ...
        <title>Ward <?php echo $wardno; ?></title>
    </head>
    <body>
	    <section class="main">
            <!-- ==========Sidebar============= -->
            <?php
                include '../../layout/ward_member/sidebar_change_password.php';
            ?>
            <!-- ==========Sidebar End============= -->
            <div class="container">
                <div class="header">
                ...
                <div class="change-pass">
                    ...
                    <form id="cp-form" action="../../../model/ward_member/change_password.php" method="post" enctype="multipart/form-data">
                        <input type="text" name="userid" value="<?php echo $wardno; ?>" id="user-id" style="display: none;">
                        <div class="inputs">
        ...
        <script>
            ...
            function validateCurrentPass ( curpass )
            {
                ...
                if ( curpass.length != 0 ){
                    $.ajax( {
                        url: "../../../model/ward_member/change_password.php",
                        type: "POST",
                        data: {
                            curPass: curpass,
                            userId: userId
